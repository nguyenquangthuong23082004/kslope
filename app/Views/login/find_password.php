...
<?php $this->section('content'); ?>
    ...
    <main id="container" class="main main_new">
        <form name="frm" class="frm" method="post" action="#">
            ...
            <section class="join-account">
                ...
                <h2 class="join-title">비밀번호 찾기</h2>

                <div class="login_tab">
                    <button type="button" class="" onclick="go_find_id();">ID 찾기</button>
                    <button type="button" class="on">비밀번호 찾기</button>
                </div>
    ...
    <script>
        ...
        async function sendVerifyCode() {
            let url = '/member/find_password/send_verify_code';
        ...
        async function handleVerifyCode() {
            let url = '/member/find_password/verify_code';
        ...
        async function submit_it() {
            let url = '/member/find_password/final';
