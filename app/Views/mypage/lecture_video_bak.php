                                ...
                                <div class="eduCourse-list">
                                    ...
                                    <?php else: ?>
                                        <?php foreach ($course['videos'] as $video): ?>
                                            <div class="eduCourse-item" data-video-idx="<?= $video['video_idx'] ?>">
                                                <!-- Video Thumbnail -->
                                                    ...
                                                    <div class="eduCourse-bottom">
                                                        ...
                                                        <div class="eduCourse-action">
                                                            <div class="eduCourse-timeWrap">
                                                                ...
                                                                <p><span>강의시간 :</span> <?= $video['duration'] ?>분</p>
                                                            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        class VideoProgressTracker {
            constructor(videoIdx, courseIdx, videoType, embedUrl) {
            ...
            async loadInitialProgress() {
                try {
                    ...
                    if (result.status === 'success' && result.data) {
                        ...
                        this.totalWatchTime = result.data.total_watch_time || 0;
            ...
            updateProgressUI(progress, isCompleted) {
                const videoItem = document.querySelector(`[data-video-idx="${this.videoIdx}"]`);
                if (!videoItem) return;
