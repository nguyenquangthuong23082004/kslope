    ...
    <section class="law-section">
        <div class="law-inner">
            ...
            <div class="law-block">
                ...
                <div class="law-box">
                    급경사지 법제6조 및 같은법 시행규칙 제2조에 따라 붕괴위험지역으로 지정·고시를 할 때에는 붕괴위험지역의 지형도면 등의 서류를 제출하여야 한다
                </div>
            </div>
                ...
                <div class="law-box">
                    <ol class="law-list">
                        ...
                        <li>
                            <ul>
                                <li>
                                    급경사지 붕괴위험지역 지형도면 작성은 신뢰성과 전문성이 필요하다. 행정안전부 「급경사지 관리 실무편람」에 따르면 급경사지 붕괴위험지역 지형도면 <br>
                                    작성시에는 지적'이 표시된 지형도에 지역·지구 등을 명시하여야 하며, 측량을 통한 급경사지 영 역, 면적 등의 확정을 통해 작성되어야 한다.
                                </li>
                            </ul>
                        </li>
                        <li>
                            <ul>
                                <li>
                                    급경사지 붕괴위험지역으로 지정되면 급경사지법 제10조(붕괴위험지역에서의 행위 협의)에 따라 구조물의 설치 행위, 건축물을 신축하거나 증축·개축하는 <br>
                                    행위 등이 제 한됨으로 토지소유주와 분쟁의 소지가 있어 붕괴위험지역의 지형도면 작성은 급경사 지 전문가의 정확한 측량을 통해 급경사지 시·종점및 <br>
                                    영역 등을 결정하는 것이 바람 직하다.
                                </li>
                            </ul>
                        </li>
                        <li>
                            <ul>
                                <li>
                                    또한 급경사지 상부는 대부분 조사자의 접근이 어렵고, 안전 문제 등의 이유로 드 론 및 라이다 등 최신기술을 활용하고, 급경사지 전문가의 측량을통해 <br>
                                    결정하는 것이 안전하고 효율적이다.
                                </li>
                            </ul>
                        </li>
            ...
            <div class="law-block">
                <div class="law-gallery-wrap">
                        ...
                        <div class="law-slider-viewport">
                            ...
                            <div class="swiper law-main-swiper">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide"><img src="/assets/img/sub/gallery_map_01.png" alt="">
                                    </div>
                                    <div class="swiper-slide"><img src="/assets/img/sub/gallery_map_02.png" alt="">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="swiper law-thumb-swiper">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide"><img src="/assets/img/sub/gallery_map_01.png"></div>
                            <div class="swiper-slide"><img src="/assets/img/sub/gallery_map_02.png"></div>
                        </div>
                    </div>
                    ...
                    <!-- <p class="law-gallery-caption js-gallery-caption"></p> -->
                    <p class="law-gallery-caption-all">드론을 활용한 급경사지 붕괴위험지역 3차원 영상</p>
                </div>
            </div>
                ...
                <div class="law-gallery-wrap">
                    ...
                    <div class="law-slider-outer">
                        ...
                        <div class="law-slider-viewport">
                            ...
                            <div class="swiper law-main-swiper">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide"><img src="/assets/img/sub/gallery_map_03.png" alt="">
                                    </div>
                                    <div class="swiper-slide"><img src="/assets/img/sub/gallery_map_04.png" alt="">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="swiper law-thumb-swiper">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide"><img src="/assets/img/sub/gallery_map_03.png"></div>
                            <div class="swiper-slide"><img src="/assets/img/sub/gallery_map_04.png"></div>
                        </div>
                    </div>
                    ...
                    <p class="law-gallery-caption js-gallery-caption"></p>
                    <!-- <p class="law-gallery-caption-all">급경사지 대책공법 수립(기본계획)</p> -->
                </div>
            </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const captionsByGallery = [
            ["", ""],
            ["드론을 활용한 지형측량", "지형도면 작성 사례"],
        ];

        document.querySelectorAll(".law-gallery-wrap").forEach((wrap, gi) => {
            const captions = captionsByGallery[gi] || [];
            const captionEl = wrap.querySelector(".js-gallery-caption");

            const thumbEl = wrap.querySelector(".law-thumb-swiper");
            const mainEl = wrap.querySelector(".law-main-swiper");
            const nextEl = wrap.querySelector(".law-next");
            const prevEl = wrap.querySelector(".law-prev");
            ...
            const mainSwiper = new Swiper(mainEl, {
                ...
                on: {
                    init: function() {
                        if (captionEl) captionEl.innerText = captions[this.realIndex] || "";
                    },
            ...
            thumbSwiper.on("click", function() {
                ...
                if (typeof i === "number" && captionEl) {
                    captionEl.innerText = captions[i] || "";
                }
            });

            if (captionEl) captionEl.innerText = captions[0] || "";
        });
