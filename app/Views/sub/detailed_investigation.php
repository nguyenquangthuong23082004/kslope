    ...
    <section class="law-section">
        <div class="law-inner">
            ...
            <div class="law-block">
                ...
                <div class="law-box">
                    급경사지법 제12조(붕괴위험지역 정비 중기계획의 수립), 동법 시행령 제6조 및 행 정안전부고시 제2025-68호(급경사지 붕괴위험지역 정비사업 기준)
                </div>
            </div>
                ...
                <div class="law-box">
                    <ol class="law-list">
                        <li>
                            <ul>
                                <li>
                                    붕괴위험지역 급경사지에 대한 기본 및 일반현황, 위험성, 피해도에 대한 조사 및 분석을 통하여 해당 급경사지의 안정성 확보를 위한 보수·보강공법과 예상 <br>
                                    사업비 를 제시한다.
                                </li>
                            </ul>
                        </li>
                        ...
                        <li>
                            <ul>
                                <li>
                                    '급경사지 정밀조사'는 대상지 및 주변에 대한 현장조사를 원칙으로 하며, 필요시 지반조사, 토질시험, 비파괴시험, 드론 측량 등을 선택적으로 추가 수행할 <br>
                                    수 있으 며, 안정해석 등을 통하여 위험성을 수치화하고 안정성 확보 및 피해 저감을 위한 구조·비구조적 대책을 수립하여 '정비 중기계획' 및 "실시설계'에 <br>
                                    활용한다.
                                </li>
                            </ul>
                        </li>
            ...
            <div class="law-block">
                <div class="law-gallery-wrap">
                        ...
                        <div class="law-slider-viewport">
                            ...
                            <div class="swiper law-main-swiper">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide"><img src="/assets/img/sub/gallery_detail_01.png" alt="">
                                    </div>
                                    <div class="swiper-slide"><img src="/assets/img/sub/gallery_detail_02.png" alt="">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="swiper law-thumb-swiper">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide"><img src="/assets/img/sub/gallery_detail_01.png"></div>
                            <div class="swiper-slide"><img src="/assets/img/sub/gallery_detail_02.png"></div>
                        </div>
                    </div>
                    ...
                    <p class="law-gallery-caption-all">급경사지 붕괴지역 현장조사</p>
                </div>
            </div>
                ...
                <div class="law-gallery-wrap">
                    ...
                    <div class="law-slider-outer">
                        ...
                        <div class="law-slider-viewport">
                            ...
                            <div class="swiper law-main-swiper">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide"><img src="/assets/img/sub/gallery_detail_03.png" alt="">
                                    </div>
                                    <div class="swiper-slide"><img src="/assets/img/sub/gallery_detail_04.png" alt="">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="swiper law-thumb-swiper">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide"><img src="/assets/img/sub/gallery_detail_03.png"></div>
                            <div class="swiper-slide"><img src="/assets/img/sub/gallery_detail_04.png"></div>
                        </div>
                    </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const captionsByGallery = [
            // ["동작구 사당동 아파트 옹벽", "광주 대화아파트"], 
            // ["두 번째 갤러리 1번 캡션", "두 번째 갤러리 2번 캡션"] 
        ];
