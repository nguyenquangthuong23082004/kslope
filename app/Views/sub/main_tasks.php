...
<main id="container" class="main main_new">
    <section class="ci-intro">
        ...
        <div class="ci-visual">
            <img src="/assets/img/sub/ci_visual_main_tasks.png" alt="">
    ...
    <section class="law-section">
        <div class="law-inner">
            ...
            <div class="law-block">
                ...
                <div class="law-box">
                    급경사지법 제8조에 따라 급경사지 지반의 침하ㆍ활동·전도(顚倒) 및 붕괴 등으로 위치 변화를 사전에 감지하기 위하여 필요하다고 판단되는 경우에는 상시계측을 할수 있다.
                </div>
            </div>
            ...
            <div class="law-block">
                ...
                <div class="law-box">
                    <ol class="law-list">
                        ...
                        <ul>
                            <li>
                                급경사지 관리기관이 수행중인 급경사지 상시계측관리 체계 구축 사업의 추진과정(설 계,
                                설치, 시운전)에서 발생할 수 있는 문제점을 사전 "전문가 검수"를 통해 단계별로 개 선하고,
                                '최신 행정안전부 급경사지 붕괴위험지역 주민대피관리기준(2021)」, 「계측표준시 방서(2016)
                                」등 상시계측관련 지침서를 검토하여 과업의 품질확보 및 완성도를 향상시키는 데 목적이 있다.
                            </li>
                            <li>
                                또한 계측기기의 설치 및 DB 연계 후 "시운전"을 통해 상시계측관리 체계의 안정화를 도모하고, 전문가의 계측센서 데이터 분석 등을 통해 장기적인 성능
                                유지관리방안을 마련 함으로써 급경사지 상시계측관리를 효율적으로 관리하고자 한다.
                            </li>
                        </ul>
                    </ol>
                </div>
            ...
            <div class="law-block">
                <div class="law-gallery-wrap">
                        ...
                        <div class="law-slider-viewport">
                            ...
                            <div class="swiper law-main-swiper">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide"><img src="/assets/img/sub/worker01.png"></div>
                                    <div class="swiper-slide"><img src="/assets/img/sub/worker02.png"></div>
                                </div>
                            </div>
                    ...
                    <p class="law-gallery-caption-all">전문가 현장자문을 통한 상시계측관리시스템 검수 및 시운전</p>
                </div>
            </div>
                ...
                <div class="law-gallery-wrap">
                    ...
                    <div class="law-slider-outer">
                        ...
                        <div class="law-slider-viewport">
                            ...
                            <div class="swiper law-main-swiper">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide"><img src="/assets/img/sub/map_01.png"></div>
                                    <div class="swiper-slide"><img src="/assets/img/sub/map_02.png"></div>
                                </div>
                            </div>
                    ...
                    <p class="law-gallery-caption" id="galleryCaption"></p>
                    <p class="law-gallery-caption-all">상시계측관리 운영시스템 및 데이터 검수</p>
                </div>
            </div>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    document.querySelectorAll(".law-gallery-wrap").forEach(function (gallery) {

        const mainEl  = gallery.querySelector(".law-main-swiper");
        const thumbEl = gallery.querySelector(".law-thumb-swiper");
        const nextEl  = gallery.querySelector(".law-next");
        const prevEl  = gallery.querySelector(".law-prev");
    ...
    if (container && activeTab) {
        ...
        smoothScrollTo(container, targetLeft, 600);
    }


    function smoothScrollTo(el, targetLeft, duration = 600) {
        const startLeft = el.scrollLeft;
        const diff = targetLeft - startLeft;
        const startTime = performance.now();
