			...
			<div id="contents" class="email_container email_container04">
				...
				<input type="hidden" name="gubun" value="<?=$gubun?>">
						...
						<table cellpadding="0" cellspacing="0" summary="" class="listTable01 email_form01" style="table-layout:fixed;">
							...
							<tbody>
								...
								<tr>
									...
									<td class="inbox" colspan="3"><input type="text" style="width:80%;"></td>
								</tr>
							</tbody>
						</table>
					...
					<div style="text-align:center;margin-bottom:10px;">
						<button type="button" class="btn_save03">조회</button>
					</div>
				</form>
				<script>
				function search_it()
					...
					<div class="listBottom">
						...
						<tbody>
							<tr>
								<td>115421</td>
								<td>개별</td>
								<td><a href="javascript:void(0)">[본토]이재현님 가입을 진심으로 축하드립니다.쇼핑 적립금 5,000원을 선물로 넣어드렸습니다.</a></td>
								<td>
									<p>1명</p>
								</td>
