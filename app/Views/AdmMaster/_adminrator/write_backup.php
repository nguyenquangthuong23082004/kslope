								...
								<table style="width:100%">
									...
									<tr style="height:45px">
										...
										<td>
											...
											<input type="checkbox" name="auth[]" value="B03" id="B03"> <label for="B03">이메일 관리</label>
											<input type="checkbox" name="auth[]" value="B04" id="B04"> <label for="B04">SMS 관리</label>
										</td>
									</tr>
									<tr style="height:45px">
										...
										<td>
											...
											<input type="checkbox" name="auth[]" value="C04" id="C04"> <label for="C04">제휴상담/신청</label>
										</td>
									</tr>
									<tr style="height:45px">
									...
									<tr style="height:45px">
										...
										<td>
											...
											<input type="checkbox" name="auth[]" value="E02" id="E02"> <label for="E02">상품후기</label>
										</td>
									</tr>
									<tr style="height:45px">
									...
									<tr style="height:45px">
										<td style="width:120px;text-align:center;background-color:#fafafa;font-weight:bold;color:#000000">배너관리</td>
										<td>
											<input type="checkbox" name="auth[]" value="G01" id="G01"> <label for="G01">배너관리</label>
										</td>
									</tr>
									<tr style="height:45px">
										...
										<td>
											...
											<input type="checkbox" name="auth[]" value="H03" id="H03"> <label for="H03">관리자 접속IP</label>
											<input type="checkbox" name="auth[]" value="H04" id="H04"> <label for="H04">정책설정</label>
											<input type="checkbox" name="auth[]" value="H05" id="H05"> <label for="H05">배송사 관리</label>
											<input type="checkbox" name="auth[]" value="H06" id="H06"> <label for="H06">약관 및 정책</label>
										</td>
									</tr>
									<tr style="height:45px">
										<td style="width:120px;text-align:center;background-color:#fafafa;font-weight:bold;color:#000000">통계</td>
										<td>
											<input type="checkbox" name="auth[]" value="I01" id="I01"> <label for="I01">주문분석</label>
											<input type="checkbox" name="auth[]" value="I02" id="I02"> <label for="I02">매출분석</label>
											<input type="checkbox" name="auth[]" value="I03" id="I03"> <label for="I03">방문분석</label>
											<input type="checkbox" name="auth[]" value="I04" id="I04"> <label for="I04">상품분석</label>
											<input type="checkbox" name="auth[]" value="I05" id="I05"> <label for="I05">회원분석</label>
										</td>
									</tr>
									<tr style="height:45px">
										<td style="width:120px;text-align:center;background-color:#fafafa;font-weight:bold;color:#000000">운영관리</td>
										<td>
											<input type="checkbox" name="auth[]" value="J01" id="J01"> <label for="J01">쿠폰관리</label>
											<input type="checkbox" name="auth[]" value="J02" id="J02"> <label for="J02">쿠폰설정</label>
											<input type="checkbox" name="auth[]" value="J03" id="J03"> <label for="J03">TOP5</label>
											<input type="checkbox" name="auth[]" value="J04" id="J04"> <label for="J04">인기상품</label>
											<input type="checkbox" name="auth[]" value="J05" id="J05"> <label for="J05">박리다매 DEAL</label>
											<input type="checkbox" name="auth[]" value="J06" id="J06"> <label for="J06">본토회원DEALL</label>
											<input type="checkbox" name="auth[]" value="J07" id="J07"> <label for="J07">본토장터</label>
											<input type="checkbox" name="auth[]" value="J08" id="J08"> <label for="J08">9장 DEAL</label>
											<input type="checkbox" name="auth[]" value="J09" id="J09"> <label for="J09">예약판매</label>
											<input type="checkbox" name="auth[]" value="J10" id="J10"> <label for="J10">매장관리</label>
											<input type="checkbox" name="auth[]" value="J11" id="J11"> <label for="J11">팝업관리</label>
										</td>
									</tr>
									<tr style="height:45px">
										<td style="width:120px;text-align:center;background-color:#fafafa;font-weight:bold;color:#000000">재고관리</td>
										<td>
											<input type="checkbox" name="auth[]" value="K01" id="K01"> <label for="K01">재고관리</label>
											<input type="checkbox" name="auth[]" value="K02" id="K02"> <label for="K02">본사 재고추가</label>
											<input type="checkbox" name="auth[]" value="K03" id="K03"> <label for="K03">대리점 재고관리</label>
											<input type="checkbox" name="auth[]" value="K04" id="K04"> <label for="K04">매장재고현황</label>
										</td>
									</tr>
