...
<div id="container" class="gnb_setting"> <span id="print_this"><!-- 인쇄영역 시작 //-->
	...
	<header id="headerContainer">
		<div class="inner">
			...
			<div class="menus">
				<ul>
					<li><a href="/AdmMaster/_adminrator/store_config_admin.php" class="btn btn-default"><span class="glyphicon glyphicon-th-list"></span><span class="txt">리스트</span></a></li>
						...
						<tr height="45" class="cls_out">
							...
							<td colspan="3">
								<table style="width:100%">
									...
									<?
									foreach($_Adm_grant_name as $keys=>$vals){
									?>
									<tr style='height:45px'>
										<td style='width:120px;text-align:center;background-color:#fafafa;font-weight:bold;color:#000000'><?=$vals?></td>
										<td>
										<input type='checkbox' name='' value='' id=''> <label for=''>sdsd</label>
			...
			<div class="tail_menu">
				<ul>
					...
					<li class="right_sub">
						...
						<a href="/AdmMaster/_adminrator/store_config_admin.php" class="btn btn-default"><span class="glyphicon glyphicon-th-list"></span><span class="txt">리스트</span></a>
