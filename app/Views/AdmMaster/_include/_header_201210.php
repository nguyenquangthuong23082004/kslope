			...
			<div class="headerSet">
				...
				<p class="pic">
					<a href="/" target="_blank">
						<img src="<?=_IT_LOGOS?>" alt="<?=_IT_SITE_NAME?>">
					</a>
				</p>
				<div class="settings">
					<p class="config"><b><?=$_SESSION[member][name]?></b>님 접속중 <a href="/AdmMaster/_adminrator/adm_setting.php"><img src="/AdmMaster/_images/common/ico_setting.png" alt="설정" /></a> <!-- &nbsp;<a href="/AdmMaster/logout.php"><img src="/AdmMaster/_images/common/logout.png" alt="로그아웃" /></a>//--></p>
					<div class="config2">
					<h1><span class="col_yellow"> <?=_IT_SITE_NAME?> <?=$_SESSION[member][name]?></span></h1>
				...
				<div id="gnb" class="gnb_update">
					<ul class="gnb_menu">
						...
						<li class="menu1  <? if($code == "notice" || $code == "faq" || $code == "event" || $code == "event_notice" )  { ?>on<? }?>"><a href="/AdmMaster/_bbs/board_list.php?code=notice"><img src="/AdmMaster/_images/common/gnb_ico_01.png" alt="" /> <span class="tit">고객센터</span></a>
...
<!-- 								<li class=""><a href="/AdmMaster/_bbs/board_list.php?code=as">A/S</a></li> -->
						...
						<li class="menu11  <? if(strpos($_SERVER[PHP_SELF], "/AdmMaster/_member/") !== false)  { ?>on<? }?>"><a href="/AdmMaster/_member/list.php"><img src="/AdmMaster/_images/common/gnb_ico_02.png" alt="" /> <span class="tit">회원관리</span></a>
							<ul class="smenu_11">
						...
						<li class="menu3  <? if(strpos($_SERVER[PHP_SELF], "/AdmMaster/_counsel/") !== false ||$code == "qna"  || $code == "ContactUs")  { ?>on<? }?>"><a href="/AdmMaster/_bbs/board_list.php?code=qna"><img src="/AdmMaster/_images/common/gnb_ico_03.png" alt="" /> <span class="tit">문의</span></a>
							<ul class="smenu_3">
						...
						<li class="menu4  <? if(strpos($_SERVER[PHP_SELF], "/AdmMaster/_code/") !== false)  { ?>on<? }?>"><a href="/AdmMaster/_code/list.php"><img src="/AdmMaster/_images/common/gnb_ico_04.png" alt="" /> <span class="tit">코드관리</span></a>
							<ul class="smenu_4">
						...
						<li class="menu6  <? if(strpos($_SERVER[PHP_SELF], "/AdmMaster/_goods/") !== false)  { ?>on<? }?>"><a href="/AdmMaster/_goods/list.php"><img src="/AdmMaster/_images/common/gnb_ico_05.png" alt="" /> <span class="tit">상품관리</span></a>
							<ul class="smenu_6">
						...
						<li class="menu13  <? if(strpos($_SERVER[PHP_SELF], "/AdmMaster/_order/") !== false)  { ?>on<? }?>"><a href="/AdmMaster/_order/list.php"><img src="/AdmMaster/_images/common/gnb_ico_06.png" alt="" /> <span class="tit">주문관리</span></a>
							<ul class="smenu_13">
							</ul>
						</li>

						<li class="menu5  <? if( $code == "banner" )  { ?>on<? }?>"><a href="/AdmMaster/_bbs/board_list.php?code=banner&scategory=16"><img src="/AdmMaster/_images/common/gnb_ico_07.png" alt="" /> <span class="tit">배너관리</span></a>
							<ul class="smenu_5">
							<?
							...
							?>
								<li><a href='/AdmMaster/_bbs/board_list.php?code=banner&scategory=<?=$frow["tbc_idx"]?>'><?=$frow["subject"]?></a></li>
							<?
							}
							?>
							</ul>
						...
						<li class="menu7  <? if(strpos($_SERVER[PHP_SELF], "/AdmMaster/_adminrator/") !== false )  { ?>on<? }?>"><a href="/AdmMaster/_adminrator/setting.php"><img src="/AdmMaster/_images/common/gnb_ico_08.png" alt="" /> <span class="tit">기본설정</span></a>
							<ul class="smenu_7">
						...
						<li class="menu16  <? if(strpos($_SERVER[PHP_SELF], "/AdmMaster/_statistics/") !== false )  { ?>on<? }?>"><a href="/AdmMaster/_statistics/statistics01_01.php"><img src="/AdmMaster/_images/common/gnb_ico_09.png" alt="" /><span class="tit">통계</span></a>
							<ul class="smenu_16">
						...
						<li class="menu8  <? if(strpos($_SERVER[PHP_SELF], "/AdmMaster/_operator/") !== false || strpos($_SERVER[PHP_SELF], "/AdmMaster/_front/") !== false )  { ?>on<? }?>"><a href="/AdmMaster/_operator/coupon_list.php"><img src="/AdmMaster/_images/common/gnb_ico_10.png" alt="" /> <span class="tit">운영관리</span></a>
							<ul class="smenu_8">
