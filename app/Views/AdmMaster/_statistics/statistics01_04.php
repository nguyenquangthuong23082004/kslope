		...
		<span id="print_this"><!-- 인쇄영역 시작 //-->
			...
			<header id="headerContainer">
				...
				<div class="inner">
					...
					<div class="menus">
						<ul class="first">
							<li><a href="statistics01_01.php" class="btn btn_email01">카테고리(소분류별)</a></li>	
							<li><a href="statistics01_02.php" class="btn btn_email01">카테고리(중분류별)</a></li>	
							<li><a href="statistics01_03.php" class="btn btn_email01">브랜드별 통계</a></li>	
							<li><a href="statistics01_04.php" class="btn btn_email01">브랜드별 통계(판매분)</a></li>	
