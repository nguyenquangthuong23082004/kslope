...
$sql = "
			select * from (
				...
				select 	
					...
					,0 as direct_dc 
					,0 as last_price 
					,0 as coupon_dc_price 
					,0 as coupon_dc_count
					,0 as order_code_count
					,0 as nCont
					,0 as cancel 	 
				from tbl_month where month not in(
				
					select MONTH(b.regdate) as regdate
						from tbl_order as a 
							inner join (
											select 
												order_code
												...
												, count(*) as order_code_count
												, regdate
											from tbl_order_sub group by order_code									
											) as b
								on a.order_code = b.order_code
