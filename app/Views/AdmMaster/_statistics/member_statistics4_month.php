    ...
    <span id="print_this">
        <div id="mainContentMenu" class="contentMenu">
            <ul>
                ...
                <li class="contentMenuSub selected"><a href="member_statistics4_month.php">검색어통계(월간)</a></li>
                    ...
                    <div class="listSelectR">
                        <div class="contentMenu">
                            <ul>
                                ...
                                <li class="contentMenuSub selected" data-mode="month"><a href="member_statistics4_month.php">월간통계</a></li>
