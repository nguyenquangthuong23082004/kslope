    ...
    <span id="print_this">
        <div id="mainContentMenu" class="contentMenu">
            <ul>
                ...
                <li class="contentMenuSub selected"><a href="member_statistics4.php">검색어통계</a></li>
        ...
        <div id="contents">
            <div class="content">
                        ...
                        <form name="modifyForm1" method="get" action="" autocomplete="off">
                            <div class="firstLine selectYear d-flex gap-2" style="padding-left:0">
                                ...
                                <select name="days" onchange="fn_search()" class="form-select">
                                    <?php for($ds=1; $ds<=31; $ds++): ?>
                                        <option value="<?= $ds ?>" <?= ($ds==$days)?"selected":"" ?>><?= $ds ?>일</option>
                                    <?php endfor; ?>
                                </select>
                            </div>
                        </form>
                    ...
                    <div class="listSelectR">
                        <div class="contentMenu">
                            <ul>
                                ...
                                <li class="contentMenuSub selected" data-mode="day" style="width: calc(20% - 2px);"><a href="member_statistics4_day.php">일간통계</a></li>
                                <li class="contentMenuSub" data-mode="detail" style="width: calc(20% - 2px);"><a href="member_statistics4.php">특정기간통계</a></li>
                            </ul>
                ...
                <div id="listArea">
                    <h4><?= $s_date ?> (총 <?= number_format($total_cnt) ?>회)</h4>
