			...
			<header id="headerContainer">
				...
				<div class="inner">
					...
					<div class="menus">
						...
						<ul class="last">
							<li><a href="coupon_write.php" class="btn btn-primary"><span class="glyphicon glyphicon-pencil"></span> <span class="txt">신규등록</span></a></li>
						</ul>
					...
					<div class="listBottom">
						...
						<tbody>
							...
							<tr style="height:50px">
								<td><input type="checkbox" name="idx[]" class="idx code_idx" value="<?=$row['c_idx']?>"  /></td>
								<td><?=$num--?></td>
								...
								<td class="tac"><a href="javascript:del_it('<?=$row['c_idx']?>');"><img src="/AdmMaster/_images/common/ico_error.png" alt="에러" /></a></td>
							</tr>
							<?  } ?>
						...
						<div class="inner">
							<div class="menus">
								...
								<ul class="last">
									...
									<li><a href="coupon_write.php" class="btn btn-primary"><span class="glyphicon glyphicon-pencil"></span> <span class="txt">신규 등록</span></a></li>
								</ul>
		...
		<div class="coupon_pop">
			<div>
				<form action="find_user.php" onsubmit="return fn_chk_coupon();">
					...
					<h2>아이디찾기</h2>
						<input type="text" name="tmp_user_id" id="tmp_user_id" onkeyup="javascript:press_it()" ><button type="button" onclick="fn_chk_coupon();" class="search">검색</button>
					</div>
					<div class="table_box">
						<table>
