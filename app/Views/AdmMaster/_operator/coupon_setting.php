			...
			<header id="headerContainer">
				...
				<div class="inner">
					...
					<div class="menus">
						...
						<ul class="last">
							<li><a href="coupon_setting_write.php" class="btn btn-primary"><span class="glyphicon glyphicon-pencil"></span> <span class="txt">신규등록</span></a></li>
						</ul>
					...
					<div class="listBottom">
						...
						<tbody>
							...
							<tr style="height:50px">
								<td><?=$num--?></td>
								<td class="tac"><a href="coupon_setting_write.php?idx=<?=$row['idx']?>"><?=$row["coupon_name"]?></a></td>
								<td class="tac">
									<?
								...
								<!--
								<td class="tac"><?=$row["dex_price_pe"]?> %</td>
								-->
								...
								<td>
									<a href="coupon_setting_write.php?idx=<?=$row['idx']?>"><img src="/AdmMaster/_images/common/ico_setting2.png" alt="설정" /></a> 
						...
						<div class="inner">
							<div class="menus">
								...
								<ul class="last">
									...
									<li><a href="coupon_setting_write.php" class="btn btn-primary"><span class="glyphicon glyphicon-pencil"></span> <span class="txt">신규 등록</span></a></li>
								</ul>
