<?
	...
	$sql = " SELECT * FROM tbl_goods where item_state = 'sale' and (goods_name_front like '%".$tmp_goods."%' or goods_name_back  like '%".$tmp_goods."%' ) and g_idx not in (select g_idx from tbl_booking) order by goods_name_front asc ";
