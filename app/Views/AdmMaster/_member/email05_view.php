						...
						<div>
							<div>
								<div>
									...
									<a href="javascript:search_it()" class="btn btn-default btn_email03" onclick="OpenPreview();"><span class="txt">미리보기</span></a>
									...
									<a href="javascript:search_it()" class="btn btn-default btn_email03"><span class="txt">바로발송</span></a>
								</div>
							</div>
						</div>
...
<script>
	function OpenPreview(){
		window.open('','미리보기',"width=800, height=700,left=560,top=160, toolbar=no, menubar=no, scrollbars=no, resizable=yes")
	}
</script>
