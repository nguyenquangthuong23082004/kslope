		...
		<span id="print_this"><!-- 인쇄영역 시작 //-->
			...
			<header id="headerContainer">
				...
				<div class="inner">
					...
					<div class="menus">
						<ul class="first">
							<li><a href="email01.php" class="btn btn_email01">자동메일설정</a></li>	
							<li><a href="email02.php" class="btn btn_email01">단체메일발송</a></li>	
							<li><a href="email03.php" class="btn btn_email01">개별메일발송</a></li>	
							<li><a href="email04.php" class="btn btn_email01">메일발송내역</a></li>	
							<li class="mr_10"><a href="email05.php" class="btn btn_email01">단체매일 디자인/발송</a></li>
									
							<li><a href="email05_view.php" class="btn btn-success btn_dd01">등록</a></li>	
