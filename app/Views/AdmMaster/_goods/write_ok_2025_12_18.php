    ...
    <div id="print_this"><!-- 인쇄영역 시작 //-->
        ...
        <div id="contents">
			...
			<?*/ ?>
                                ...
                                <td>
                                    <?php 
                                        $add_sql = "
                                            ...
                                            ORDER BY onum DESC, code_idx DESC
                                        ";
                                        $add_res = mysqli_query($connect, $add_sql);
                                    ...
                                    <?php 
                                        while ($row_add = mysqli_fetch_array($add_res)) {
                                            $val = $row_add['code_no'];

                                            $checked = in_array($val, $goods_additional_arr) ? "checked" : "";
                                    ?>
                                        <label style="margin-right:15px;">
                                            <input type="checkbox"
                                                name="goods_additional[]"
                                                id="goods_additional_<?= $val ?>"
                                                value="<?= $val ?>"
                                                <?= $checked ?>>
                                            <?= $row_add['code_name'] ?>
                                        </label>
                                ...
                                <td>
                                    <div class="<?= $typeName ?>_table">
                                        <table>
                                            ...
                                            <?php 
                                            for ($i=1; $i<=4; $i++) { 
                                                $mRow = mysqli_fetch_array(mysqli_query($connect,
                                                    "SELECT * FROM tbl_goods_manage 
                                                    WHERE g_code='$goods_code' AND type='$typeName' AND gubun='$i'"
                                                ));
                                            ?>
                                            <tr>
                                                <th>
                                                    <input type="hidden" name="<?= $typeName ?>_gubun<?= $i ?>" value="<?= $i ?>">

                                                    사용:
                                                    <input type="checkbox"
                                                        name="<?= $typeName ?>_use<?= $i ?>"
                                                        id="<?= $typeName ?>_use<?= $i ?>"
                                                        value="Y"
                                                        <?= ($mRow['useYN']=='Y' ? "checked" : "") ?>>

                                                    <select name="<?= $typeName ?>_period<?= $i ?>" id="<?= $typeName ?>_period<?= $i ?>">
                                                        <option value="">선택</option>
                                                        <?php
                                                        $pRes = mysqli_query($connect, "
                                                            SELECT * FROM tbl_code 
                                                            WHERE status='Y' 
                                                            AND parent_code_no = '$typeName'
                                                            ORDER BY onum DESC, code_idx DESC
                                                        ");
                                                ...
                                                $d1 = mysqli_fetch_array(mysqli_query($connect,
                                                    ...
                                                    WHERE type='$typeName' AND g_code='$goods_code'
                                                    AND gubun='$i' AND gubun2='1'"
                                                ));
                                                ?>
                                                <td>
                                                    <input type="hidden" name="<?= $typeName ?>_gubun<?= $i ?>_1" value="1">

                                                    <input type="checkbox"
                                                        name="<?= $typeName ?>_price_chk<?= $i ?>_1"
                                                        id="<?= $typeName ?>_price_chk<?= $i ?>_1"
                                                        class="<?= $typeName ?>_price_chk<?= $i ?>"
                                                        value="Y"
                                                        <?= ($d1['price_chk']=='Y' ? "checked" : "") ?>>
                                                    <label for="<?= $typeName ?>_price_chk<?= $i ?>_1">가격적용</label> |

                                                    표 머리글:
                                                    <input type="text"
                                                        name="<?= $typeName ?>_subject<?= $i ?>_1"
                                                        id="<?= $typeName ?>_subject<?= $i ?>_1"
                                                        value="<?= $d1['subject'] ?>">

                                                    가격:
                                                    <input type="text"
                                                        name="<?= $typeName ?>_price<?= $i ?>_1"
                                                        id="<?= $typeName ?>_price<?= $i ?>_1"
                                                        value="<?= $d1['price'] ?>"
                                                        numberOnly>

                                                    | 결합할인 적용( - 표기 )
                                                    <input type="checkbox"
                                                        name="<?= $typeName ?>_cmbind_discnt<?= $i ?>_1"
                                                        id="<?= $typeName ?>_cmbind_discnt<?= $i ?>_1"
                                                        class="<?= $typeName ?>_cmbind_discnt<?= $i ?>"
                                                        value="Y"
                                            ...
                                            <!-- <?php for ($j=2; $j<=4; $j++) { 
                                                $d = mysqli_fetch_array(mysqli_query($connect,
                                                    "SELECT * FROM tbl_goods_manage_detail 
                                                    WHERE type='$typeName' AND g_code='$goods_code'
                                                    AND gubun='$i' AND gubun2='$j'"
                                                ));
                                            ?>
                                            <tr>
                                                <td>
                                                    <input type="hidden" name="<?= $typeName ?>_gubun<?= $i ?>_<?= $j ?>" value="<?= $j ?>">

                                                    <input type="checkbox"
                                                        name="<?= $typeName ?>_price_chk<?= $i ?>_<?= $j ?>"
                                                        id="<?= $typeName ?>_price_chk<?= $i ?>_<?= $j ?>"
                                                        class="<?= $typeName ?>_price_chk<?= $i ?>"
                                                        value="Y"
                                                        <?= ($d['price_chk']=='Y' ? "checked" : "") ?>>
                                                    <label for="<?= $typeName ?>_price_chk<?= $i ?>_<?= $j ?>">가격적용</label> |

                                                    표 머리글:
                                                    <input type="text"
                                                        name="<?= $typeName ?>_subject<?= $i ?>_<?= $j ?>"
                                                        id="<?= $typeName ?>_subject<?= $i ?>_<?= $j ?>"
                                                        value="<?= $d['subject'] ?>">

                                                    가격:
                                                    <input type="text"
                                                        name="<?= $typeName ?>_price<?= $i ?>_<?= $j ?>"
                                                        id="<?= $typeName ?>_price<?= $i ?>_<?= $j ?>"
                                                        value="<?= $d['price'] ?>"
                                                        numberOnly>

                                                    | 결합할인 적용( - 표기 )
                                                    <input type="checkbox"
                                                        name="<?= $typeName ?>_cmbind_discnt<?= $i ?>_<?= $j ?>"
                                                        id="<?= $typeName ?>_cmbind_discnt<?= $i ?>_<?= $j ?>"
                                                        class="<?= $typeName ?>_cmbind_discnt<?= $i ?>"
                                                        value="Y"
                                                        <?= ($d['cmbind_discnt']=='Y' ? "checked" : "") ?>>
                                                </td>
                                            </tr>
                                            <?php } ?> -->
                        ...
                        <?php 
                            $sql_option       = "select * from tbl_goods_moption where g_idx = '". $g_idx ."' and use_yn = 'Y' order by onum desc ";
                                    ...
                                    <td>
                                        ...
                                        <div>
                                            <table>
                                                ...
                                                <?php
                                                // 옵션 조회
                                                $fsql3    = "select * from tbl_goods_option where g_idx = '".$g_idx."' and code_idx = '". $row_option['code_idx'] ."' order by onum desc ";
