...
<?
	...
	$total_sql = " select *	from tbl_freebies_code where 1=1 $strSql ";
...
<div class="page-heading mb-4">
    ...
    <div class="d-flex justify-content-between align-items-center">
        ...
        <h4 class="text-center">사은품코드관리</h4>
    </div>
</div>
				...
				<div class="inner">
					<div class="menus">
						...
						<ul class="last">
							...
							<li><a href="freebies_write.php" class="btn btn-primary"><span class="glyphicon glyphicon-pencil"></span> <span class="txt">신규등록</span></a></li>
						</ul>
					...
					<div class="listBottom">
						...
						<tbody>
							...
							<tr style="height:50px">
								...
								<td class="tal"><a href="freebies_write.php?code_idx=<?=$row["code_idx"]?>"><?=$row["code_name"]?></a></td>
					...
					<div id="headerContainer">
						...
						<div class="inner">
							<div class="menus">
								...
								<ul class="last">
									<li><a href="javascript:change_it()" class="btn btn-success">순위변경</a></li>
									<li><a href="freebies_write.php" class="btn btn-primary"><span class="glyphicon glyphicon-pencil"></span> <span class="txt">신규 등록</span></a></li>
								</ul>
