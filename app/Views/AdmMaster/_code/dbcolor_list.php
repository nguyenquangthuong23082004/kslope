...
<?
	...
	$total_sql = " select *	from tbl_dbcolor where 1=1 $strSql ";
				...
				<div class="inner">
					...
					<div class="menus">
						...
						<ul class="last">
							...
							<li><a href="dbcolor_write.php" class="btn btn-primary"><span class="glyphicon glyphicon-pencil"></span> <span class="txt">신규등록</span></a></li>
						</ul>
						...
						<tbody>
							...
							?>
								<tr style="height:50px">
									...
									<td class="tal">
										<span style="border: 1px solid rgb(204, 204, 204); border-image: none; background:<?=$row["color_code"]?>;margin-right:10px;">&nbsp;&nbsp;&nbsp;&nbsp;</span>
										<?=$row["color_code"]?>
									</td>
									<td class="tal"><a href="dbcolor_write.php?code_idx=<?=$row["code_idx"]?>"><?=$row["code_name"]?></a></td>
					...
					<div id="headerContainer">
						...
						<div class="inner">
							<div class="menus">
								...
								<ul class="last">
									<li><a href="javascript:change_it()" class="btn btn-success">순위변경</a></li>
									<li><a href="dbcolor_write.php" class="btn btn-primary"><span class="glyphicon glyphicon-pencil"></span> <span class="txt">신규 등록</span></a></li>
								</ul>
