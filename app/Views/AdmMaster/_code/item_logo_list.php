...
<?
	...
	$total_sql = " select *	from tbl_item_logo where 1=1 $strSql ";
...
<div class="page-heading mb-4">
    ...
    <div class="d-flex justify-content-between align-items-center">
        ...
        <h4 class="text-center">제품로고 리스트</h4>
    </div>
</div>
				...
				<div class="inner">
					<div class="menus">
						...
						<ul class="last">
							...
							<li><a href="item_logo_write.php" class="btn btn-primary"><span class="glyphicon glyphicon-pencil"></span> <span class="txt">신규등록</span></a></li>
						</ul>
					...
					<div class="listBottom">
						...
						<tbody>
							...
							<tr style="height:50px">
								...
								<td class="tal"><a href="item_logo_write.php?code_idx=<?=$row["code_idx"]?>"><?=$row["code_name"]?></a></td>

								<td class="tal">
									<img src="/data/item_logo/<?=$row["ufile"]?>" style="max-height:200px">
								</td>
					...
					<div id="headerContainer">
						...
						<div class="inner">
							<div class="menus">
								...
								<ul class="last">
									<li><a href="javascript:change_it()" class="btn btn-success">순위변경</a></li>
									<li><a href="item_logo_write.php" class="btn btn-primary"><span class="glyphicon glyphicon-pencil"></span> <span class="txt">신규 등록</span></a></li>
								</ul>
