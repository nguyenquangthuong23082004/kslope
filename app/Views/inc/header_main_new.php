...
<link href="<?= base_url('assets/css/header_main_new.css') ?>" rel="stylesheet" type="text/css" />
<style>
        ...
        <div class="kssa-wrap">
            ...
            <div class="kssa-top">
                <a href="/" class="kssa-logo">
                    <img src="/assets/img/header/logo_kssa_new.svg" alt="KSSA"/>
                </a>
                ...
                <div class="kssa-auth">
                    <?php if (isset($member) && isset($member['name'])): ?>
                        ...
                        ?>
                        <a href="#!">안녕하세요! <span style="color: #0d6efd"><?= $member['name'] ?></span><?php if ($memberTypeLabel): ?>, <span style="color:rgb(255, 255, 255); font-size: 0.9em"><?= $memberTypeLabel ?></span><?php endif; ?></a>
                        <span class="sep">|</span>
                        <a href="/logout">로그아웃</a>
                        <a href="/lecture_video" class="mypage-link">
                            <img src="/assets/img/header/ico_mypage_new.png" alt="mypage"/>
                            <span class="mypage-txt">Mypage</span>
                        </a>
                    <?php else: ?>
                        <a href="/login">로그인</a>
                        <span class="sep">|</span>
            ...
            <div class="kssa-bottom">
                <nav class="kssa-gnb">
                    <button class="btn-hamburger" type="button" aria-label="menu">
                        <img src="/assets/img/header/ico_hamburger_new.png" alt="menu"/>
                    </button>
                    ...
                    <ul class="kssa-menu">
                        ...
                        <li><a href="/apply_for_training">계측전문인력 교육</a></li>
                    </ul>
                </nav>
